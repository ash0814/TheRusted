...
#include "Projectile_Muriel_Primary.generated.h"

/**
 * 
 */
UCLASS()
class THERUSTED_API AProjectile_Muriel_Primary : public AProjectile_Particle_Cascade
{
	GENERATED_BODY()
protected:
