...
#include "RSS/Public/Character_Player.h"
#include "EnhancedInputSubsystems.h"
#include "EnhancedInputComponent.h"
#include "InputActionValue.h"
#include "RSS/Public/Projectile_Muriel_Attack1.h"
...
void ACharacter_Player::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (PlayerInput)
	{
		PlayerInput->BindAction(IA_Move, ETriggerEvent::Triggered, this, &ACharacter_Player::Input_Move);
		PlayerInput->BindAction(IA_Turn, ETriggerEvent::Triggered, this, &ACharacter_Player::Input_Turn);
		PlayerInput->BindAction(IA_LookUp, ETriggerEvent::Triggered, this, &ACharacter_Player::Input_LookUp);
		PlayerInput->BindAction(IA_Jump, ETriggerEvent::Triggered, this, &ACharacter_Player::Input_Jump);
		PlayerInput->BindAction(IA_Attack1, ETriggerEvent::Started, this, &ACharacter_Player::Input_Attack1);
		PlayerInput->BindAction(IA_Attack2, ETriggerEvent::Started, this, &ACharacter_Player::Input_Attack2);
		PlayerInput->BindAction(IA_Skill1, ETriggerEvent::Started, this, &ACharacter_Player::Input_Skill1);
	}
}

void ACharacter_Player::Input_Move(const FInputActionValue& inputValue)
{
...
void ACharacter_Player::Input_Turn(const struct FInputActionValue& inputValue)
{
...
void ACharacter_Player::Input_LookUp(const struct FInputActionValue& inputValue)
{
	float value = inputValue.Get<float>();
...
void ACharacter_Player::Input_Jump(const struct FInputActionValue& inputValue)
{
	Jump();
}

void ACharacter_Player::Input_Attack1(const struct FInputActionValue& inputValue)
{
...
void ACharacter_Player::Input_Attack2(const struct FInputActionValue& inputValue)
{
	MontagePlay(AM_Attack2);
	Excute_Attack1();
}

void ACharacter_Player::Input_Skill1(const struct FInputActionValue& inputValue)
{
	MontagePlay(AM_Skill1);
	Excute_Attack1();
}

void ACharacter_Player::MontagePlay(UAnimMontage* animMontage)
{
	if(AnimInstance)
	{		
...
void ACharacter_Player::Excute_Attack1()
{
	FHitResult Hit;
	...
	FVector S = GetMesh()->GetSocketLocation(FName("Muzzle_01"));
	if(result)
	{		
