...
// Sets default values
AASH_CBullet_Enemy::AASH_CBullet_Enemy()
{
...
void AASH_CBullet_Enemy::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AASH_CBullet_Enemy::Tick(float DeltaTime)
{
...
void AASH_CBullet_Enemy::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
