...
ARSS_Projectile_Muriel_Attack1::ARSS_Projectile_Muriel_Attack1()
{
...
void ARSS_Projectile_Muriel_Attack1::BeginPlay()
{
	Super::BeginPlay();	
...
// Called every frame
void ARSS_Projectile_Muriel_Attack1::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
	SetActorLocation(GetActorLocation() + GetActorForwardVector() * 500 * DeltaTime, true);
}

void ARSS_Projectile_Muriel_Attack1::DestroyProjectile()
{	
